...
from .views import home_view ,suggestion_Get ,Thanks_View,Sug_View,Product_Get,Product_View,update_product,delete_product,Product_View_User,user_login,register,user_logout,About,Dummy
urlpatterns = [path('', home_view, name='home'),
               ...
               path('products_list/', Product_View_User, name='products_list'),
